...
namespace AMMS.Infrastructure.Interfaces
{
    public interface IPurchaseRepository
    {
        ...
        Task<PagedResultLite<PurchaseOrderWithItemsDto>> GetPurchaseOrdersAsync(int page, int pageSize, CancellationToken ct = default);

        Task<PagedResultLite<PurchaseOrderWithItemsDto>> GetPendingPurchasesAsync(int page, int pageSize, CancellationToken ct = default);
